...
跟着日期自动换配色与粒子，也可以手动指定（想现在看看就选一个）：**樱花季** 3/20~4/20（粉樱配色 + 多撒的花瓣）、**飘雪** 12/1~2/15（冷色调 + 自上而下的雪，这时不再飘花瓣）、**新年** 1/1~1/3（金红配色，问候语变成「新年快乐」）、**生日**（填 `MM-DD`，粉紫配色 + 彩色纸屑，问候语变成「生日快乐」）。不想看就把节日设成「关闭」。
